...
static uint32_t hash_key(unsigned char *key)
{
...
static void node_free(be_node node)
{
...
static unsigned char* dict_set_entry(be_node *entries, size_t capacity, unsigned char *key,void *val, size_t *length, be_type type)
{
...
static bool dict_expand(be_dict *dict)
{
